...
# → produces  hadsync-<version>.vsix  in this directory
...
**VS Code UI alternative:** `Cmd+Shift+P` → `Extensions: Install from VSIX...` → select the `.vsix` file produced in step 3.
